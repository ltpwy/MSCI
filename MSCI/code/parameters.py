...
parser.add_argument("--sampling_rate", help="Frequency of layer feature extraction", type=int, default=12)
parser.add_argument("--adversarial_loss_weight", help="weight of the confusion_loss", type=int, default=0.1)
parser.add_argument("--selected_low_layers", help="number of selected layers", type=int, default=3)
parser.add_argument("--selected_high_layers", help="number of selected layers", type=int, default=3)
parser.add_argument("--stage_1_dropout", help="number of selected layers", type=float, default=0.2)
parser.add_argument("--stage_2_dropout", help="number of selected layers", type=float, default=0.2)
parser.add_argument("--fusion_dropout", help="number of selected layers", type=float, default=0.1)
parser.add_argument("--stage_1_num_heads", help="number of selected layers", type=int, default=12)
parser.add_argument("--stage_2_num_heads", help="number of selected layers", type=int, default=12)
parser.add_argument("--stage_1_num_cmt_layers", help="number of selected layers", type=int, default=1)
parser.add_argument("--stage_2_num_cmt_layers", help="number of selected layers", type=int, default=1)
